...
public class AuditableAspect {
    ...
    @Before("com.iteller.kl.spring.aop.pointcut.CombinePointcutAspect.anyPublicOperation() " +
            "&& @annotation(auditable)")
    public void audit(Auditable auditable){
        auditable.value();
    }

    @Before(value = "com.iteller.kl.spring.aop.pointcut.CombinePointcutAspect.anyPublicOperation() " +
            "&& target(bean) " +
